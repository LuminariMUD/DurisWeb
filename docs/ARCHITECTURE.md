...
Production preflight checks the published object and mob markers, counts, and
child consistency. Release acceptance must still verify the enabled feature's
API data and rendered surface.
