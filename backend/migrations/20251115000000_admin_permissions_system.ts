...
export async function up(knex: Knex): Promise<void> {
  ...
  const permissions = [
    ...
    {
      permission_key: "manage_help_files",
      permission_name: "Manage Help Files",
      description: "Create, edit, and delete help files",
      category: "content",
      sort_order: 1,
    },
    {
      permission_key: "manage_news",
    ...
    {
      permission_key: "manage_motd",
      permission_name: "Manage MOTD & Static Pages",
      description: "Edit MOTD, Wiz MOTD, Rules, Credits, Info, Wizlist, FAQ",
      category: "content",
      sort_order: 3,
    },
    {
      permission_key: "manage_forum_settings",
      permission_name: "Manage Forum Settings",
      description: "Edit forum settings and configuration",
      category: "content",
      sort_order: 4,
    },
    {
      permission_key: "manage_forum_categories",
      permission_name: "Manage Forum Categories",
      description: "Create, edit, and archive forum categories",
      category: "content",
      sort_order: 5,
    },
    {
      permission_key: "moderate_forum",
      permission_name: "Moderate Forum",
      description: "Moderate posts and threads (lock, pin, move, delete)",
      category: "content",
      sort_order: 6,
    },
    ...
    // Zone & World (1)
    {
      permission_key: "manage_zones",
      permission_name: "Manage Zones",
      description: "Create, edit, and delete zones and zone properties",
      category: "zone",
      sort_order: 7,
    },
    ...
    // Server Monitoring (3)
    {
      permission_key: "view_server_logs",
      permission_name: "View Server Logs",
      description: "View and download server logs",
      category: "monitoring",
      sort_order: 8,
    },
    {
      permission_key: "view_server_health",
      permission_name: "View Server Health",
      description: "View health metrics, crashes, and incidents",
      category: "monitoring",
      sort_order: 9,
    },
    {
      permission_key: "view_connection_logs",
      permission_name: "View Connection Logs",
      description: "View login/logout tracking and IP analysis",
      category: "monitoring",
      sort_order: 10,
    },
    ...
    // MUD Configuration (4)
    {
      permission_key: "manage_mud_properties",
      permission_name: "Manage MUD Properties",
      description: "Edit game properties and configuration",
      category: "configuration",
      sort_order: 11,
    },
    {
      permission_key: "manage_level_cap",
      permission_name: "Manage Level Cap",
      description: "View and modify level cap settings",
      category: "configuration",
      sort_order: 12,
    },
    {
      permission_key: "manage_timers",
      permission_name: "Manage Timers",
      description: "View and modify global game timers",
      category: "configuration",
      sort_order: 13,
    },
    {
      ...
      description: "View analytics dashboard and statistics",
      category: "monitoring",
      sort_order: 14,
    },
    ...
    // System Administration (1)
    {
      ...
      description: "Assign roles and permissions to accounts (Overlord-only)",
      category: "system",
      sort_order: 15,
    },
  ];
  ...
  const roles = [
    {
      ...
      description: "Can manage help files, news, and MOTD pages",
      is_system_role: true,
      created_by: "system",
    },
    {
      role_name: "Zone Manager",
      description: "Can create and edit zones",
      is_system_role: true,
      created_by: "system",
    },
    {
      role_name: "Server Monitor",
      description: "Can view server logs, health, and connection logs",
      is_system_role: true,
      created_by: "system",
    },
    {
      role_name: "Full Admin",
      description: "All permissions except permission management",
      is_system_role: true,
      created_by: "system",
    },
  ];

  await knex("admin_roles").insert(roles).onConflict("role_name").ignore();

  // Get permission and role IDs for mapping
  const permissionsMap = await knex("admin_permissions").select(
    "id",
    "permission_key",
  );
  ...
  const getPermissionId = (key: string) =>
    permissionsMap.find((p) => p.permission_key === key)?.id;
  const getRoleId = (name: string) =>
    rolesMap.find((r) => r.role_name === name)?.id;
  ...
  if (contentEditorId) {
    await knex("admin_role_permissions").insert([
      {
        role_id: contentEditorId,
        permission_id: getPermissionId("manage_help_files")!,
      },
      {
        role_id: contentEditorId,
        permission_id: getPermissionId("manage_news")!,
      },
      {
        role_id: contentEditorId,
        permission_id: getPermissionId("manage_motd")!,
      },
    ]);
  }
  ...
  if (zoneManagerId) {
    await knex("admin_role_permissions").insert([
      {
        role_id: zoneManagerId,
        permission_id: getPermissionId("manage_zones")!,
      },
      {
        role_id: zoneManagerId,
        permission_id: getPermissionId("view_server_logs")!,
      },
    ]);
  }
  ...
  if (serverMonitorId) {
    await knex("admin_role_permissions").insert([
      {
        role_id: serverMonitorId,
        permission_id: getPermissionId("view_server_logs")!,
      },
      {
        role_id: serverMonitorId,
        permission_id: getPermissionId("view_server_health")!,
      },
      {
        role_id: serverMonitorId,
        permission_id: getPermissionId("view_connection_logs")!,
      },
      {
        role_id: serverMonitorId,
        permission_id: getPermissionId("view_analytics")!,
      },
    ]);
  }
