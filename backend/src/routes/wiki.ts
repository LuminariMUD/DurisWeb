...
router.get('/map/layers', checkWikiAccess, async (_req: Request, res: Response, next: NextFunction) => {
  try {
    const layers = [
...
router.get('/map/continents', checkWikiAccess, async (_req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/map/bounds', checkWikiAccess, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/map/image', checkWikiAccess, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { layer } = req.query;
...
router.get('/map/tiles', checkWikiAccess, mapTilesLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/map/entrances', checkWikiAccess, mapTilesLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { minX, maxX, minY, maxY, layer } = req.query;
...
router.get('/zones/search', checkWikiAccess, listLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/zones', checkWikiAccess, listLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      page = '1',
      limit = '20',
...
router.get('/zones/:number', checkWikiAccess, detailLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/zones/:number/map-data', checkWikiAccess, detailLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const zoneNumber = Number(req.params.number);
...
router.get('/objects', checkWikiAccess, listLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      page = '1',
      limit = '20',
    ...
    if (excludeTypes) {
      filters.excludeTypes = String(excludeTypes).split(',').map(Number).filter((n) => !isNaN(n));
    }
    ...
    if (spellEffects) {
      filters.spellEffects = String(spellEffects).split(',').map((s) => s.trim()).filter(Boolean);
    }
...
router.get('/objects/:vnum', checkWikiAccess, detailLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/mobs', checkWikiAccess, listLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      page = '1',
      limit = '20',
...
router.get('/mobs/:zoneNumber/:vnum', checkWikiAccess, detailLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get('/zones/:number/spawns', checkWikiAccess, detailLimiter, async (req: Request, res: Response, next: NextFunction) => {
  try {
    const zoneNumber = Number(req.params.number);
