...
const alpha2ToNumeric: Record<string, string> = {
  ...
  'GL': '304', 'GD': '308', 'GT': '320', 'GN': '324', 'GW': '624', 'GY': '328', 'HT': '332',
  ...
  'LT': '440', 'LU': '442', 'MK': '807', 'MG': '450', 'MW': '454', 'MY': '458', 'MV': '462',
  'ML': '466', 'MT': '470', 'MR': '478', 'MU': '480', 'MX': '484', 'MD': '498', 'MC': '492',
  ...
  'PT': '620', 'PR': '630', 'QA': '634', 'RO': '642', 'RU': '643', 'RW': '646', 'SA': '682',
  'SN': '686', 'RS': '688', 'SL': '694', 'SG': '702', 'SK': '703', 'SI': '705', 'SO': '706',
  ...
  'VE': '862', 'VN': '704', 'YE': '887', 'ZM': '894', 'ZW': '716', 'XK': '-99', 'PS': '275',
  'LOCAL': '000'
}
...
async function loadTopoJSON() {
  try {
    ...
    const countriesGeo = topojson.feature(world, world.objects.countries) as unknown as { features: Feature<Geometry>[] }
