...
// Get zones query
export function useZonesQuery(filters: Ref<ZoneFilters>, pagination: Ref<PaginationParams>) {
  return useQuery({
...
export function useUpdateZoneMutation() {
  ...
  return useMutation({
    mutationFn: async ({ zoneNumber, data }: { zoneNumber: number; data: ZoneUpdateData }) => {
...
export function useBulkUpdateZonesMutation() {
  ...
  return useMutation({
    mutationFn: async ({ zoneNumbers, data }: { zoneNumbers: number[]; data: ZoneUpdateData }) => {
